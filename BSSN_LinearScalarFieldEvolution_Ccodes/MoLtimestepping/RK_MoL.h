...
apply_inner_parity_conditions(&params, &bcstruct, NUM_EVOL_GFS, evol_gf_parity, k_odd_gfs);
enforce_detgammabar_constraint(&rfmstruct, &params, k_odd_gfs);
...
apply_inner_parity_conditions(&params, &bcstruct, NUM_EVOL_GFS, evol_gf_parity, k_even_gfs);
enforce_detgammabar_constraint(&rfmstruct, &params, k_even_gfs);
