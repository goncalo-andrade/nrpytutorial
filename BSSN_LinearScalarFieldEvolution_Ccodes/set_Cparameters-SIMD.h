...
const REAL            NOSIMDAMPL = params->AMPL;
const REAL_SIMD_ARRAY AMPL = ConstSIMD(NOSIMDAMPL);
const REAL            NOSIMDSINHW = params->SINHW;
const REAL_SIMD_ARRAY SINHW = ConstSIMD(NOSIMDSINHW);
const REAL            NOSIMDM = params->M;
const REAL_SIMD_ARRAY M = ConstSIMD(NOSIMDM);
const REAL            NOSIMDchi = params->chi;
const REAL_SIMD_ARRAY chi = ConstSIMD(NOSIMDchi);
...
const REAL            NOSIMDw = params->w;
const REAL_SIMD_ARRAY w = ConstSIMD(NOSIMDw);
const REAL            NOSIMDomega = params->omega;
const REAL_SIMD_ARRAY omega = ConstSIMD(NOSIMDomega);
const int m = params->m;
const REAL            NOSIMDeta = params->eta;
const REAL_SIMD_ARRAY eta = ConstSIMD(NOSIMDeta);
const REAL            NOSIMDmu_s = params->mu_s;
const REAL_SIMD_ARRAY mu_s = ConstSIMD(NOSIMDmu_s);
const REAL            NOSIMDPI = params->PI;
